...
class Redis
  ...
  def send_blocking_command(command, timeout, &); end
...
class Redis::Client
  ...
  def call_with_timeout(command, extra_timeout, &); end

  # source://redis//lib/redis/client.rb#263
  def call_without_timeout(command, &); end
  ...
  def without_socket_timeout(&); end
...
class Redis::Cluster
  ...
  def call_with_timeout(command, timeout, &); end
...
module Redis::Commands::Hashes
  ...
  def hscan_each(key, **options, &); end
...
module Redis::Commands::Keys
  ...
  def sort(key, by: T.unsafe(nil), limit: T.unsafe(nil), get: T.unsafe(nil), order: T.unsafe(nil),
           store: T.unsafe(nil))
  end
...
module Redis::Commands::Pubsub
  ...
  def psubscribe(*channels, &); end

  # Listen for messages published to channels matching the given patterns.
  # Throw a timeout error if there is no messages for a timeout period.
  #
  # source://redis//lib/redis/commands/pubsub.rb#50
  def psubscribe_with_timeout(timeout, *channels, &); end
  ...
  def subscribe_with_timeout(timeout, *channels, &); end
...
module Redis::Commands::Sets
  ...
  def sscan_each(key, **options, &); end
...
module Redis::Commands::SortedSets
  ...
  def zadd(key, *args, nx: T.unsafe(nil), xx: T.unsafe(nil), lt: T.unsafe(nil), gt: T.unsafe(nil), ch: T.unsafe(nil),
           incr: T.unsafe(nil))
  end
  ...
  def zrange(key, start, stop, byscore: T.unsafe(nil), by_score: T.unsafe(nil), bylex: T.unsafe(nil),
             by_lex: T.unsafe(nil), rev: T.unsafe(nil), limit: T.unsafe(nil), withscores: T.unsafe(nil), with_scores: T.unsafe(nil))
  end
  ...
  def zrangestore(dest_key, src_key, start, stop, byscore: T.unsafe(nil), by_score: T.unsafe(nil),
                  bylex: T.unsafe(nil), by_lex: T.unsafe(nil), rev: T.unsafe(nil), limit: T.unsafe(nil))
  end
  ...
  def zscan_each(key, **options, &); end
...
module Redis::Commands::Strings
  ...
  def getex(key, ex: T.unsafe(nil), px: T.unsafe(nil), exat: T.unsafe(nil), pxat: T.unsafe(nil),
            persist: T.unsafe(nil))
  end
  ...
  def set(key, value, ex: T.unsafe(nil), px: T.unsafe(nil), exat: T.unsafe(nil), pxat: T.unsafe(nil),
          nx: T.unsafe(nil), xx: T.unsafe(nil), keepttl: T.unsafe(nil), get: T.unsafe(nil))
  end
...
class Redis::Distributed
  ...
  def subscribe(channel, *channels, &); end
