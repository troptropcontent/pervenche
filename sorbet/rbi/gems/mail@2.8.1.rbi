...
module Mail::CheckDeliveryParams
  class << self
    ...
    def check(*args, **_arg1, &); end
    def check_addr(*args, **_arg1, &); end
    def check_from(*args, **_arg1, &); end
    def check_message(*args, **_arg1, &); end
    def check_to(*args, **_arg1, &); end
    def validate_smtp_addr(*args, **_arg1, &); end
  end
end
...
module Mail::Encodings
  ...
  class << self
    ...
    def each_base64_chunk_byterange(str, max_bytesize_per_base64_chunk, &); end
...
class Mail::Retriever
  ...
  def find_and_delete(options = T.unsafe(nil), &); end
...
module Mail::Utilities
  ...
  def map_lines(str, &); end

  # source://mail//lib/mail/utilities.rb#229
  def map_with_index(enum, &); end
