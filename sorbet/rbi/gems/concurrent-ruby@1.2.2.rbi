...
module Concurrent
  ...
  def call_dataflow(method, executor, *inputs, &); end
  ...
  def dataflow_with(executor, *inputs, &); end
...
class Concurrent::Agent < Concurrent::Synchronization::LockableObject
  ...
  def send_via(executor, *args, &); end
...
class Concurrent::Collection::CopyOnNotifyObserverSet < Concurrent::Synchronization::LockableObject
  ...
  def add_observer(observer = T.unsafe(nil), func = T.unsafe(nil), &); end
  ...
  def notify_and_delete_observers(*args, &); end
...
module Concurrent::Concern::Logging
  ...
  def log(level, progname, message = T.unsafe(nil), &); end
end
...
module Concurrent::Concern::Observable
  ...
  def with_observer(observer = T.unsafe(nil), func = T.unsafe(nil), &); end
...
class Concurrent::Future < Concurrent::IVar
  ...
  class << self
    ...
    def execute(opts = T.unsafe(nil), &); end
  end
end
...
class Concurrent::IVar < Concurrent::Synchronization::LockableObject
  ...
  def try_set(value = T.unsafe(nil), &); end
...
class Concurrent::Promises::AbstractEventFuture < Concurrent::Synchronization::Object
  ...
  def chain_on(executor, *args, &); end
  ...
  def on_resolution_using(executor, *args, &); end
  ...
  def with_async(executor, *args, &); end
end
...
class Concurrent::Promises::BlockedTaskPromise < Concurrent::Promises::BlockedPromise
  ...
  def initialize(delayed, blockers_count, default_executor, executor, args, &); end
...
module Concurrent::Promises::FactoryMethods
  ...
  def delay_on(default_executor, *args, &); end
  ...
  def future_on(default_executor, *args, &); end
  ...
  def schedule(intended_time, *args, &); end
  ...
  def schedule_on(default_executor, intended_time, *args, &); end
...
class Concurrent::Promises::Future < Concurrent::Promises::AbstractEventFuture
  ...
  def on_fulfillment_using(executor, *args, &); end
  ...
  def on_rejection_using(executor, *args, &); end
  ...
  def rescue_on(executor, *args, &); end
...
class Concurrent::ScheduledTask < Concurrent::IVar
  ...
  def initialize(delay, opts = T.unsafe(nil), &); end
  ...
  class << self
    ...
    def execute(delay, opts = T.unsafe(nil), &); end
  end
end
...
class Concurrent::Synchronization::AbstractLockableObject < Concurrent::Synchronization::Object
  ...
  def ns_wait_until(timeout = T.unsafe(nil), &); end
...
module Concurrent::Synchronization::AbstractStruct
  ...
  class << self
    ...
    def define_struct_class(parent, base, name, members, &); end
  end
end
...
class Concurrent::Synchronization::Condition < Concurrent::Synchronization::LockableObject
  ...
  def wait_until(timeout = T.unsafe(nil), &); end

  class << self
    # source://concurrent-ruby//lib/concurrent-ruby/concurrent/synchronization/safe_initialization.rb#29
    def private_new(*args, &); end
