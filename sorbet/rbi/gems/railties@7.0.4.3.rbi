...
class Rails::Application < Rails::Engine
  ...
  def initialize(initial_variable_values = T.unsafe(nil), &); end
  ...
  def initializer(name, opts = T.unsafe(nil), &); end
  ...
  class << self
    ...
    def create(initial_variable_values = T.unsafe(nil), &); end
...
class Rails::Initializable::Collection < Array
  ...
  def tsort_each_child(initializer, &); end
...
class Rails::Initializable::Initializer
  ...
  def initialize(name, context, options, &); end
...
module Rails::MailersController::HelperMethods
  ...
  def locale_query(*args, **_arg1, &); end

  # source://railties//lib/rails/mailers_controller.rb#12
  def part_query(*args, **_arg1, &); end
end
...
class Rails::Railtie
  ...
  def each_registered_block(type, &); end
  ...
  class << self
    ...
    def register_block_for(type, &); end
...
class Rails::SourceAnnotationExtractor::Annotation < Struct
  ...
  class << self
    ...
    def register_extensions(*exts, &); end
