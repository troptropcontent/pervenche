...
module SimpleForm::ActionViewExtensions::Builder
  ...
  def simple_fields_for(*args, &); end
end
...
module SimpleForm::ActionViewExtensions::FormHelper
  ...
  def simple_fields_for(record_name, record_object = T.unsafe(nil), options = T.unsafe(nil), &); end

  # source://simple_form//lib/simple_form/action_view_extensions/form_helper.rb#14
  def simple_form_for(record, options = T.unsafe(nil), &); end
...
class SimpleForm::ErrorNotification
  ...
  # source://simple_form//lib/simple_form/error_notification.rb#4
  def object_name(*_arg0, **_arg1, &); end

  # source://simple_form//lib/simple_form/error_notification.rb#12
  def render; end

  # source://simple_form//lib/simple_form/error_notification.rb#4
  def template(*_arg0, **_arg1, &); end
...
class SimpleForm::FormBuilder < ActionView::Helpers::FormBuilder
  ...
  def association(association, options = T.unsafe(nil), &); end
  ...
  def attribute(attribute_name, options = T.unsafe(nil), &); end

  # source://simple_form//lib/simple_form/form_builder.rb#237
  def button(type, *args, &); end
  ...
  #
  # source://actionview/7.0.4.3/lib/action_view/helpers/form_helper.rb#2614
  def button_button(value = T.unsafe(nil), options = T.unsafe(nil), &); end
  ...
  #
  # source://simple_form//lib/simple_form/form_builder.rb#118
  def input(attribute_name, options = T.unsafe(nil), &); end
  ...
  def find_input(attribute_name, options = T.unsafe(nil), &); end
...
class SimpleForm::Inputs::Base
  ...
  def lookup_action(*_arg0, **_arg1, &); end

  # source://simple_form//lib/simple_form/inputs/base.rb#31
  def lookup_model_names(*_arg0, **_arg1, &); end
...
class SimpleForm::Wrappers::Builder
  ...
  def optional(name, options = T.unsafe(nil), &); end
