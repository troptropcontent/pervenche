...
class RBI::Tree < RBI::NodeWithComments
  ...
  def create_method(name, parameters: T.unsafe(nil), return_type: T.unsafe(nil), class_method: T.unsafe(nil),
                    visibility: T.unsafe(nil), comments: T.unsafe(nil))
  end
...
module T::Generic
  ...
  def type_member(variance = T.unsafe(nil), fixed: T.unsafe(nil), lower: T.unsafe(nil), upper: T.unsafe(nil),
                  &bounds_proc)
  end

  # source://tapioca//lib/tapioca/sorbet_ext/generic_name_patch.rb#37
  def type_template(variance = T.unsafe(nil), fixed: T.unsafe(nil), lower: T.unsafe(nil), upper: T.unsafe(nil),
                    &bounds_proc)
  end
end
...
class Tapioca::Commands::Annotations < Tapioca::Commands::CommandWithoutTracker
  ...
  def initialize(central_repo_root_uris:, auth: T.unsafe(nil), netrc_file: T.unsafe(nil),
                 central_repo_index_path: T.unsafe(nil), typed_overrides: T.unsafe(nil))
  end
...
class Tapioca::Commands::Dsl < Tapioca::Commands::CommandWithoutTracker
  ...
  def initialize(requested_constants:, requested_paths:, outpath:, only:, exclude:, file_header:, tapioca_path:,
                 should_verify: T.unsafe(nil), quiet: T.unsafe(nil), verbose: T.unsafe(nil), number_of_workers: T.unsafe(nil), auto_strictness: T.unsafe(nil), gem_dir: T.unsafe(nil), rbi_formatter: T.unsafe(nil), app_root: T.unsafe(nil))
  end
...
class Tapioca::Commands::Gem < Tapioca::Commands::Command
  ...
  def initialize(gem_names:, exclude:, prerequire:, postrequire:, typed_overrides:, outpath:, file_header:,
                 include_doc:, include_loc:, include_exported_rbis:, number_of_workers: T.unsafe(nil), auto_strictness: T.unsafe(nil), dsl_dir: T.unsafe(nil), rbi_formatter: T.unsafe(nil))
  end
...
class Tapioca::Dsl::Pipeline
  ...
  def initialize(requested_constants:, requested_paths: T.unsafe(nil), requested_compilers: T.unsafe(nil),
                 excluded_compilers: T.unsafe(nil), error_handler: T.unsafe(nil), number_of_workers: T.unsafe(nil))
  end
...
class Tapioca::Loaders::Loader
  ...
  def with_rails_application(&); end
...
module Tapioca::Runtime::Trackers::Mixin
  ...
  class << self
    ...
    def with_disabled_registration(&); end
...
class Tapioca::TypeVariableModule < Module
  ...
  def with_bound_name_pre_3_0(&); end
end
