...
module RestClient
  class << self
    ...
    def add_before_execution_proc(&); end
    ...
    def delete(url, headers = T.unsafe(nil), &); end

    # source://rest-client//lib/restclient.rb#66
    def get(url, headers = T.unsafe(nil), &); end

    # source://rest-client//lib/restclient.rb#86
    def head(url, headers = T.unsafe(nil), &); end
    ...
    def options(url, headers = T.unsafe(nil), &); end

    # source://rest-client//lib/restclient.rb#74
    def patch(url, payload, headers = T.unsafe(nil), &); end

    # source://rest-client//lib/restclient.rb#70
    def post(url, payload, headers = T.unsafe(nil), &); end
    ...
    def put(url, payload, headers = T.unsafe(nil), &); end
...
module RestClient::AbstractResponse
  ...
  def _follow_redirection(new_args, &); end
...
class RestClient::Request
  ...
  def net_http_do_request(http, req, body = T.unsafe(nil), &); end
  ...
  def transmit(uri, req, payload, &); end
...
class RestClient::Resource
  ...
  def initialize(url, options = T.unsafe(nil), backwards_compatibility = T.unsafe(nil), &); end
  ...
  def delete(additional_headers = T.unsafe(nil), &); end

  # source://rest-client//lib/restclient/resource.rb#49
  def get(additional_headers = T.unsafe(nil), &); end

  # source://rest-client//lib/restclient/resource.rb#57
  def head(additional_headers = T.unsafe(nil), &); end
  ...
  def patch(payload, additional_headers = T.unsafe(nil), &); end

  # source://rest-client//lib/restclient/resource.rb#65
  def post(payload, additional_headers = T.unsafe(nil), &); end

  # source://rest-client//lib/restclient/resource.rb#74
  def put(payload, additional_headers = T.unsafe(nil), &); end
