...
module Bootsnap
  ...
  class << self
    ...
    def setup(cache_dir:, development_mode: T.unsafe(nil), load_path_cache: T.unsafe(nil),
              ignore_directories: T.unsafe(nil), readonly: T.unsafe(nil), compile_cache_iseq: T.unsafe(nil), compile_cache_yaml: T.unsafe(nil), compile_cache_json: T.unsafe(nil))
    end
...
module Bootsnap::LoadPathCache::PathScanner
  class << self
    ...
    def walk(absolute_dir_path, relative_dir_path, &); end
  end
end
