...
class ActiveRecord::Base
  ...
  class << self
    ...
    def after_create(*args, **options, &); end

    # source://activemodel/7.0.4.3/lib/active_model/callbacks.rb#144
    def after_destroy(*args, **options, &); end

    # source://activemodel/7.0.4.3/lib/active_model/callbacks.rb#144
    def after_find(*args, **options, &); end

    # source://activemodel/7.0.4.3/lib/active_model/callbacks.rb#144
    def after_initialize(*args, **options, &); end

    # source://activemodel/7.0.4.3/lib/active_model/callbacks.rb#144
    def after_save(*args, **options, &); end

    # source://activemodel/7.0.4.3/lib/active_model/callbacks.rb#144
    def after_touch(*args, **options, &); end

    # source://activemodel/7.0.4.3/lib/active_model/callbacks.rb#144
    def after_update(*args, **options, &); end
    ...
    def around_create(*args, **options, &); end

    # source://activemodel/7.0.4.3/lib/active_model/callbacks.rb#137
    def around_destroy(*args, **options, &); end

    # source://activemodel/7.0.4.3/lib/active_model/callbacks.rb#137
    def around_save(*args, **options, &); end

    # source://activemodel/7.0.4.3/lib/active_model/callbacks.rb#137
    def around_update(*args, **options, &); end
    ...
    def before_create(*args, **options, &); end

    # source://activemodel/7.0.4.3/lib/active_model/callbacks.rb#130
    def before_destroy(*args, **options, &); end

    # source://activemodel/7.0.4.3/lib/active_model/callbacks.rb#130
    def before_save(*args, **options, &); end

    # source://activemodel/7.0.4.3/lib/active_model/callbacks.rb#130
    def before_update(*args, **options, &); end
...
class ActiveStorage::Blob < ActiveStorage::Record
  ...
  class << self
    ...
    def build_after_unfurling(io:, filename:, key: T.unsafe(nil), content_type: T.unsafe(nil), metadata: T.unsafe(nil),
                              service_name: T.unsafe(nil), identify: T.unsafe(nil), record: T.unsafe(nil))
    end

    def combine_signed_id_purposes(purpose); end
    def compose(blobs, filename:, content_type: T.unsafe(nil), metadata: T.unsafe(nil)); end

    def create_after_unfurling!(io:, filename:, key: T.unsafe(nil), content_type: T.unsafe(nil),
                                metadata: T.unsafe(nil), service_name: T.unsafe(nil), identify: T.unsafe(nil), record: T.unsafe(nil))
    end

    def create_and_upload!(io:, filename:, key: T.unsafe(nil), content_type: T.unsafe(nil), metadata: T.unsafe(nil),
                           service_name: T.unsafe(nil), identify: T.unsafe(nil), record: T.unsafe(nil))
    end

    def create_before_direct_upload!(filename:, byte_size:, checksum:, key: T.unsafe(nil), content_type: T.unsafe(nil),
                                     metadata: T.unsafe(nil), service_name: T.unsafe(nil), record: T.unsafe(nil))
    end
...
module ActiveStorage::Blob::GeneratedAssociationMethods
  ...
  # source://activerecord/7.0.4.3/lib/active_record/associations/builder/singular_association.rb#28
  def build_preview_image_attachment(*args, &); end

  # source://activerecord/7.0.4.3/lib/active_record/associations/builder/singular_association.rb#28
  def build_preview_image_blob(*args, &); end

  # source://activerecord/7.0.4.3/lib/active_record/associations/builder/singular_association.rb#32
  def create_preview_image_attachment(*args, &); end

  # source://activerecord/7.0.4.3/lib/active_record/associations/builder/singular_association.rb#36
  def create_preview_image_attachment!(*args, &); end

  # source://activerecord/7.0.4.3/lib/active_record/associations/builder/singular_association.rb#32
  def create_preview_image_blob(*args, &); end
...
ActiveStorage::Blob::INVALID_VARIABLE_CONTENT_TYPES_TO_SERVE_AS_BINARY_DEPRECATED_IN_RAILS_7 = T.let(T.unsafe(nil),
                                                                                                     Array)
...
class ActiveStorage::Previewer
  ...
  def instrument(operation, payload = T.unsafe(nil), &); end
...
class ActiveStorage::Previewer::MuPDFPreviewer < ActiveStorage::Previewer
  ...
  def draw_first_page_from(file, &); end
...
class ActiveStorage::Previewer::VideoPreviewer < ActiveStorage::Previewer
  ...
  def draw_relevant_frame_from(file, &); end
...
class ActiveStorage::Service
  ...
  def compose(source_keys, destination_key, filename: T.unsafe(nil), content_type: T.unsafe(nil),
              disposition: T.unsafe(nil), custom_metadata: T.unsafe(nil))
  end
...
module ActiveStorage::VariantRecord::GeneratedAssociationMethods
  ...
  # source://activerecord/7.0.4.3/lib/active_record/associations/builder/singular_association.rb#28
  def build_image_attachment(*args, &); end

  # source://activerecord/7.0.4.3/lib/active_record/associations/builder/singular_association.rb#28
  def build_image_blob(*args, &); end
  ...
  # source://activerecord/7.0.4.3/lib/active_record/associations/builder/singular_association.rb#32
  def create_image_attachment(*args, &); end

  # source://activerecord/7.0.4.3/lib/active_record/associations/builder/singular_association.rb#36
  def create_image_attachment!(*args, &); end

  # source://activerecord/7.0.4.3/lib/active_record/associations/builder/singular_association.rb#32
  def create_image_blob(*args, &); end
