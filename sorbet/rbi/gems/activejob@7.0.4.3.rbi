...
class ActiveJob::Base
  ...
  def _run_enqueue_callbacks(&); end
  ...
  # source://sidekiq/7.0.8/lib/sidekiq/job.rb#137
  def sidekiq_options_hash; end

  # source://sidekiq/7.0.8/lib/sidekiq/job.rb#149
  ...
  class << self
    ...
    # source://sidekiq/7.0.8/lib/sidekiq/job.rb#104
    def sidekiq_options_hash; end

    # source://sidekiq/7.0.8/lib/sidekiq/job.rb#112
    ...
    def skip_after_callbacks_if_terminated(*args, **_arg1, &); end
    ...
    # source://sidekiq/7.0.8/lib/sidekiq/job.rb#99
...
module ActiveJob::Callbacks::ClassMethods
  ...
  def around_enqueue(*filters, &); end
  ...
  def around_perform(*filters, &); end
  ...
  def before_enqueue(*filters, &); end
  ...
  def before_perform(*filters, &); end
end
...
module ActiveJob::Exceptions::ClassMethods
  ...
  def retry_on(*exceptions, wait: T.unsafe(nil), attempts: T.unsafe(nil), queue: T.unsafe(nil),
               priority: T.unsafe(nil), jitter: T.unsafe(nil))
  end
end
...
module ActiveJob::QueueName::ClassMethods
  ...
  def queue_as(part_name = T.unsafe(nil), &); end
...
module ActiveJob::QueuePriority::ClassMethods
  ...
  def queue_with_priority(priority = T.unsafe(nil), &); end
...
module ActiveJob::TestHelper
  ...
  def assert_enqueued_with(job: T.unsafe(nil), args: T.unsafe(nil), at: T.unsafe(nil), queue: T.unsafe(nil),
                           priority: T.unsafe(nil), &block)
  end
  ...
  def assert_performed_with(job: T.unsafe(nil), args: T.unsafe(nil), at: T.unsafe(nil), queue: T.unsafe(nil),
                            priority: T.unsafe(nil), &block)
  end
  ...
  def perform_enqueued_jobs(only: T.unsafe(nil), except: T.unsafe(nil), queue: T.unsafe(nil), at: T.unsafe(nil),
                            &block)
  end
