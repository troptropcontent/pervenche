...
class RedisClient
  ...
  def scan_list(cursor_index, command, &); end
...
class RedisClient::CircuitBreaker
  ...
  def initialize(error_threshold:, error_timeout:, error_threshold_timeout: T.unsafe(nil),
                 success_threshold: T.unsafe(nil))
  end
...
module RedisClient::Common
  ...
  def initialize(config, id: T.unsafe(nil), connect_timeout: T.unsafe(nil), read_timeout: T.unsafe(nil),
                 write_timeout: T.unsafe(nil))
  end
...
module RedisClient::Config::Common
  ...
  def initialize(username: T.unsafe(nil), password: T.unsafe(nil), db: T.unsafe(nil), id: T.unsafe(nil),
                 timeout: T.unsafe(nil), read_timeout: T.unsafe(nil), write_timeout: T.unsafe(nil), connect_timeout: T.unsafe(nil), ssl: T.unsafe(nil), custom: T.unsafe(nil), ssl_params: T.unsafe(nil), driver: T.unsafe(nil), protocol: T.unsafe(nil), client_implementation: T.unsafe(nil), command_builder: T.unsafe(nil), inherit_socket: T.unsafe(nil), reconnect_attempts: T.unsafe(nil), middlewares: T.unsafe(nil), circuit_breaker: T.unsafe(nil))
  end
...
class RedisClient::Decorator::Client
  ...
  # source://redis-client//lib/redis_client/decorator.rb#60
  def scan(*args, **_arg1, &); end

  # source://redis-client//lib/redis_client/decorator.rb#69
  def size; end

  # source://redis-client//lib/redis_client/decorator.rb#60
  def sscan(*args, **_arg1, &); end
...
module RedisClient::Decorator::CommandsMixin
  ...
  def blocking_call(*args, **_arg1, &); end

  # source://redis-client//lib/redis_client/decorator.rb#25
  def blocking_call_v(*args, **_arg1, &); end

  # source://redis-client//lib/redis_client/decorator.rb#25
  def call(*args, **_arg1, &); end

  # source://redis-client//lib/redis_client/decorator.rb#25
  def call_once(*args, **_arg1, &); end

  # source://redis-client//lib/redis_client/decorator.rb#25
  def call_once_v(*args, **_arg1, &); end

  # source://redis-client//lib/redis_client/decorator.rb#25
  def call_v(*args, **_arg1, &); end
end
...
class RedisClient::Pooled
  ...
  def initialize(config, id: T.unsafe(nil), connect_timeout: T.unsafe(nil), read_timeout: T.unsafe(nil),
                 write_timeout: T.unsafe(nil), **kwargs)
  end
  ...
  # source://redis-client//lib/redis_client/pooled.rb#56
  def multi(*args, **_arg1, &); end

  # source://redis-client//lib/redis_client/pooled.rb#56
  def pipelined(*args, **_arg1, &); end

  # source://redis-client//lib/redis_client/pooled.rb#56
  def pubsub(*args, **_arg1, &); end
