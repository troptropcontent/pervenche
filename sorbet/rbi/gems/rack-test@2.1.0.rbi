...
module Rack::Test::Methods
  ...
  def authorize(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def basic_authorize(*args, **_arg1, &); end
  ...
  # source://forwardable/1.3.3/forwardable.rb#231
  def clear_cookies(*args, **_arg1, &); end
  ...
  # source://forwardable/1.3.3/forwardable.rb#231
  def custom_request(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def delete(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def env(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def follow_redirect!(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def get(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def head(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def header(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def last_request(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def last_response(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def options(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def patch(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def post(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def put(*args, **_arg1, &); end
  ...
  # source://forwardable/1.3.3/forwardable.rb#231
  def request(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def set_cookie(*args, **_arg1, &); end
...
class Rack::Test::Session
  ...
  def custom_request(verb, uri, params = T.unsafe(nil), env = T.unsafe(nil), &); end
  ...
  def delete(uri, params = T.unsafe(nil), env = T.unsafe(nil), &); end
  ...
  # source://rack-test//lib/rack/test.rb#111
  def get(uri, params = T.unsafe(nil), env = T.unsafe(nil), &); end

  # source://rack-test//lib/rack/test.rb#111
  def head(uri, params = T.unsafe(nil), env = T.unsafe(nil), &); end
  ...
  # source://rack-test//lib/rack/test.rb#111
  def options(uri, params = T.unsafe(nil), env = T.unsafe(nil), &); end

  # source://rack-test//lib/rack/test.rb#111
  def patch(uri, params = T.unsafe(nil), env = T.unsafe(nil), &); end

  # source://rack-test//lib/rack/test.rb#111
  def post(uri, params = T.unsafe(nil), env = T.unsafe(nil), &); end

  # source://rack-test//lib/rack/test.rb#111
  def put(uri, params = T.unsafe(nil), env = T.unsafe(nil), &); end
  ...
  def request(uri, env = T.unsafe(nil), &); end
