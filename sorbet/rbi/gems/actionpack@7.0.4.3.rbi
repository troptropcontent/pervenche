...
module AbstractController::Caching
  ...
  def cache(key, options = T.unsafe(nil), &); end
...
module AbstractController::Caching::Fragments::ClassMethods
  ...
  def fragment_cache_key(value = T.unsafe(nil), &); end
end
...
module AbstractController::Callbacks::ClassMethods
  ...
  def after_action(*names, &); end

  # source://actionpack//lib/abstract_controller/callbacks.rb#204
  def append_after_action(*names, &); end

  # source://actionpack//lib/abstract_controller/callbacks.rb#204
  def append_around_action(*names, &); end

  # source://actionpack//lib/abstract_controller/callbacks.rb#204
  def append_before_action(*names, &); end

  # source://actionpack//lib/abstract_controller/callbacks.rb#204
  def around_action(*names, &); end

  # source://actionpack//lib/abstract_controller/callbacks.rb#204
  def before_action(*names, &); end

  # source://actionpack//lib/abstract_controller/callbacks.rb#210
  def prepend_after_action(*names, &); end

  # source://actionpack//lib/abstract_controller/callbacks.rb#210
  def prepend_around_action(*names, &); end

  # source://actionpack//lib/abstract_controller/callbacks.rb#210
  def prepend_before_action(*names, &); end
...
module AbstractController::Collector
  ...
  def atom(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def bmp(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def css(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def csv(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def gif(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def gzip(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def html(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def ics(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def jpeg(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def js(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def json(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def m4a(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def mp3(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def mp4(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def mpeg(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def multipart_form(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def ogg(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def otf(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def pdf(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def png(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def rss(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def svg(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def text(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def tiff(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def ttf(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def turbo_stream(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def url_encoded_form(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def vcf(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def vtt(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def webm(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def woff(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def woff2(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def xml(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/collector.rb#10
  def yaml(*args, **_arg1, &); end
  ...
  def method_missing(symbol, *args, **_arg2, &); end
...
module AbstractController::Rendering
  ...
  def _normalize_render(*args, &); end
...
module ActionController::Base::HelperMethods
  ...
  def alert(*args, **_arg1, &); end

  # source://cancancan/3.5.0/lib/cancan/controller_additions.rb#297
  def can?(*args, **_arg1, &); end

  # source://cancancan/3.5.0/lib/cancan/controller_additions.rb#297
  def cannot?(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/caching/fragments.rb#31
  def combined_fragment_cache_key(*args, **_arg1, &); end

  # source://actionpack//lib/action_controller/metal/content_security_policy.rb#11
  def content_security_policy?(*args, **_arg1, &); end

  # source://actionpack//lib/action_controller/metal/content_security_policy.rb#12
  def content_security_policy_nonce(*args, **_arg1, &); end

  # source://actionpack//lib/action_controller/metal/cookies.rb#8
  def cookies(*args, **_arg1, &); end

  # source://cancancan/3.5.0/lib/cancan/controller_additions.rb#297
  def current_ability(*args, **_arg1, &); end

  # source://devise/4.9.2/lib/devise/controllers/helpers.rb#13
  def devise_controller?(*args, **_arg1, &); end

  # source://actionpack//lib/action_controller/metal/request_forgery_protection.rb#106
  def form_authenticity_token(*args, **_arg1, &); end

  # source://actionpack//lib/action_controller/metal/flash.rb#39
  def notice(*args, **_arg1, &); end

  # source://actionpack//lib/action_controller/metal/request_forgery_protection.rb#107
  def protect_against_forgery?(*args, **_arg1, &); end

  # source://devise/4.9.2/lib/devise/controllers/helpers.rb#13
  def signed_in?(*args, **_arg1, &); end

  # source://actionpack//lib/abstract_controller/caching.rb#43
  def view_cache_dependencies(*args, **_arg1, &); end

  # source://devise/4.9.2/lib/devise/controllers/helpers.rb#13
  def warden(*args, **_arg1, &); end
end
...
module ActionController::ConditionalGet
  ...
  def fresh_when(object = T.unsafe(nil), etag: T.unsafe(nil), weak_etag: T.unsafe(nil), strong_etag: T.unsafe(nil),
                 last_modified: T.unsafe(nil), public: T.unsafe(nil), cache_control: T.unsafe(nil), template: T.unsafe(nil))
  end
...
module ActionController::ContentSecurityPolicy::ClassMethods
  ...
  def content_security_policy(enabled = T.unsafe(nil), **options, &); end
...
module ActionController::HttpAuthentication::Basic::ControllerMethods
  ...
  def authenticate_or_request_with_http_basic(realm = T.unsafe(nil), message = T.unsafe(nil), &); end
...
module ActionController::HttpAuthentication::Digest
  ...
  def authenticate(request, realm, &); end
  ...
  def validate_digest_response(request, realm, &); end
...
module ActionController::HttpAuthentication::Digest::ControllerMethods
  ...
  def authenticate_or_request_with_http_digest(realm = T.unsafe(nil), message = T.unsafe(nil), &); end
  ...
  def authenticate_with_http_digest(realm = T.unsafe(nil), &); end
...
module ActionController::HttpAuthentication::Token::ControllerMethods
  ...
  def authenticate_or_request_with_http_token(realm = T.unsafe(nil), message = T.unsafe(nil), &); end
  ...
  def authenticate_with_http_token(&); end
...
class ActionController::Parameters
  ...
  def each_element(object, filter, &); end
...
module ActionController::PermissionsPolicy::ClassMethods
  ...
  def permissions_policy(**options, &); end
end
...
module ActionController::TestCase::Behavior
  ...
  def process(action, method: T.unsafe(nil), params: T.unsafe(nil), session: T.unsafe(nil), body: T.unsafe(nil),
              flash: T.unsafe(nil), format: T.unsafe(nil), xhr: T.unsafe(nil), as: T.unsafe(nil))
  end
...
module ActionDispatch::Assertions::RoutingAssertions
  ...
  def assert_generates(expected_path, options, defaults = T.unsafe(nil), extras = T.unsafe(nil),
...
class ActionDispatch::DebugExceptions
  ...
  class << self
    ...
    def register_interceptor(object = T.unsafe(nil), &); end
  end
end
...
class ActionDispatch::FileHandler
  ...
  def initialize(root, index: T.unsafe(nil), headers: T.unsafe(nil), precompressed: T.unsafe(nil),
                 compressible_content_types: T.unsafe(nil))
  end
...
class ActionDispatch::Integration::Session
  ...
  def process(method, path, params: T.unsafe(nil), headers: T.unsafe(nil), env: T.unsafe(nil), xhr: T.unsafe(nil),
              as: T.unsafe(nil))
  end
...
class ActionDispatch::Journey::Route
  ...
  def initialize(name:, path:, app: T.unsafe(nil), constraints: T.unsafe(nil), required_defaults: T.unsafe(nil),
                 defaults: T.unsafe(nil), request_method_match: T.unsafe(nil), precedence: T.unsafe(nil), scope_options: T.unsafe(nil), internal: T.unsafe(nil))
  end
...
ActionDispatch::Journey::Router::Utils::ENCODER = T.let(T.unsafe(nil),
...
class ActionDispatch::MiddlewareStack
  ...
  def insert(index, klass, *args, **_arg3, &); end

  # source://actionpack//lib/action_dispatch/middleware/stack.rb#108
  def insert_after(index, *args, **_arg2, &); end

  # source://actionpack//lib/action_dispatch/middleware/stack.rb#100
  def insert_before(index, klass, *args, **_arg3, &); end
...
class ActionDispatch::Request::Utils
  ...
  class << self
    ...
    def each_param_value(params, &); end
...
module ActionDispatch::Routing::Mapper::Base
  ...
  def with_default_scope(scope, &); end
...
module ActionDispatch::Routing::Mapper::Concerns
  ...
  def concern(name, callable = T.unsafe(nil), &); end
...
module ActionDispatch::Routing::Mapper::CustomUrls
  ...
  def direct(name, options = T.unsafe(nil), &); end
...
module ActionDispatch::Routing::Mapper::HttpHelpers
  ...
  def map_method(method, args, &); end
end
...
module ActionDispatch::Routing::Mapper::Resources
  ...
  def apply_common_behavior_for(method, resources, options, &); end
...
class ActionDispatch::Routing::RouteSet
  ...
  def add_polymorphic_mapping(klass, options, &); end
  ...
  def add_url_helper(name, options, &); end
  ...
  def url_for(options, route_name = T.unsafe(nil), url_strategy = T.unsafe(nil), method_name = T.unsafe(nil),
              reserved = T.unsafe(nil))
  end
...
class ActionDispatch::Routing::RouteSet::NamedRouteCollection
  ...
  def add_url_helper(name, defaults, &); end
...
class ActionDispatch::SSL
  ...
  def initialize(app, redirect: T.unsafe(nil), hsts: T.unsafe(nil), secure_cookies: T.unsafe(nil),
                 ssl_default_redirect_status: T.unsafe(nil))
  end
...
class ActionDispatch::SystemTesting::Driver
  ...
  def initialize(driver_type, **options, &); end
...
class Mime::Type
  ...
  class << self
    ...
    def register(string, symbol, mime_type_synonyms = T.unsafe(nil), extension_synonyms = T.unsafe(nil),
                 skip_lookup = T.unsafe(nil))
    end
