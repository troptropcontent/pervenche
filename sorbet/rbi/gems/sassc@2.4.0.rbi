...
class SassC::Script::Value::Color < SassC::Script::Value
  ...
  def initialize(red: T.unsafe(nil), green: T.unsafe(nil), blue: T.unsafe(nil), hue: T.unsafe(nil),
                 saturation: T.unsafe(nil), lightness: T.unsafe(nil), alpha: T.unsafe(nil))
  end
