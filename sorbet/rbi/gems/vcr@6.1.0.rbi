...
module VCR
  ...
  def use_cassette(name, options = T.unsafe(nil), &); end
  ...
  def use_cassettes(cassettes, &); end
...
class VCR::Cassette::HTTPInteractionList
  ...
  def initialize(interactions, request_matchers, allow_playback_repeats = T.unsafe(nil), parent_list = T.unsafe(nil),
                 log_prefix = T.unsafe(nil))
  end
...
class VCR::Configuration
  ...
  def around_http_request(*filters, &); end
  ...
  def before_playback(tag = T.unsafe(nil), &); end
  ...
  def before_record(tag = T.unsafe(nil), &); end
  ...
  def define_cassette_placeholder(placeholder, tag = T.unsafe(nil), &); end
  ...
  #
  # source://vcr//lib/vcr/configuration.rb#225
  def filter_sensitive_data(placeholder, tag = T.unsafe(nil), &); end
  ...
  def register_request_matcher(name, &); end
...
module VCR::Configuration::DefinedHooks
  ...
  # source://vcr//lib/vcr/util/hooks.rb#55
  def after_library_hooks_loaded(*filters, &); end

  # source://vcr//lib/vcr/util/hooks.rb#55
  def before_http_request(*filters, &); end

  # source://vcr//lib/vcr/util/hooks.rb#55
  def before_playback(*filters, &); end

  # source://vcr//lib/vcr/util/hooks.rb#55
  def before_record(*filters, &); end

  # source://vcr//lib/vcr/util/hooks.rb#55
  def preserve_exact_body_bytes(*filters, &); end
end
...
module VCR::RequestIgnorer::DefinedHooks
  # source://vcr//lib/vcr/util/hooks.rb#55
  def ignore_request(*filters, &); end
end
