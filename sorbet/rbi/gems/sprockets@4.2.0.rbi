...
module Sprockets::Dependencies
  ...
  def register_dependency_resolver(scheme, &); end
...
module Sprockets::HTTPUtils
  ...
  def find_best_q_match(q_values, available, &); end
  ...
  def find_q_matches(q_values, available, &); end
...
module Sprockets::Processing
  ...
  def register_bundle_metadata_reducer(mime_type, key, *args, &); end
  ...
  def register_postprocessor(*args, &); end
  ...
  def register_preprocessor(*args, &); end
  ...
  #
  # source://sprockets//lib/sprockets/processing.rb#53
  def register_processor(*args, &); end
  ...
  def register_config_processor(type, mime_type, processor = T.unsafe(nil), &); end
...
module Sprockets::Utils
  ...
  def hash_reassoc(hash, key_a, key_b = T.unsafe(nil), &); end
