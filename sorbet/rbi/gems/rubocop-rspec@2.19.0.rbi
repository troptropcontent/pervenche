...
class RuboCop::Cop::RSpec::SubjectStub < RuboCop::Cop::RSpec::Base
  ...
  def find_subject_expectations(node, subject_names = T.unsafe(nil), &); end
end
...
class RuboCop::Cop::Style::TrailingCommaInArguments < RuboCop::Cop::Base
  ...
  # source://rubocop/1.50.1/lib/rubocop/cop/style/trailing_comma_in_arguments.rb#95
