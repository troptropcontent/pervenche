...
module ActiveModel::AttributeMethods
  ...
  def attribute_missing(match, *args, **_arg2, &); end
...
module ActiveModel::Type
  class << self
    ...
    def register(type_name, klass = T.unsafe(nil), &); end
...
module ActiveModel::Validations::Callbacks::ClassMethods
  ...
  def before_validation(*args, &); end
...
module ActiveModel::Validations::ClassMethods
  ...
  def validates_each(*attr_names, &); end
