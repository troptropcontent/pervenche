...
class Rake::Task
  ...
  def enhance(deps = T.unsafe(nil), &); end
  ...
  def transform_comments(separator, &); end
...
module Sentry
  class << self
    ...
    def add_global_event_processor(&); end
    ...
    def with_child_span(**attributes, &); end
    ...
    def with_exception_captured(**options, &); end
...
class Sentry::Backtrace
  ...
  class << self
    ...
    def parse(backtrace, project_root, app_dirs_pattern, &); end
  end
end
...
class Sentry::Breadcrumb
  ...
  def initialize(category: T.unsafe(nil), data: T.unsafe(nil), message: T.unsafe(nil), timestamp: T.unsafe(nil),
                 level: T.unsafe(nil), type: T.unsafe(nil))
  end
...
class Sentry::Configuration
  ...
  class << self
    ...
    def add_post_initialization_callback(&); end
...
class Sentry::Hub
  ...
  def capture_event(event, **options, &); end
  ...
  def start_transaction(transaction: T.unsafe(nil), custom_sampling_context: T.unsafe(nil),
                        instrumenter: T.unsafe(nil), **options)
  end
  ...
  def with_background_worker_disabled(&); end
...
module Sentry::Net::HTTP
  ...
  def request(req, body = T.unsafe(nil), &); end
...
class Sentry::Scope
  ...
  def update_from_options(contexts: T.unsafe(nil), extra: T.unsafe(nil), tags: T.unsafe(nil), user: T.unsafe(nil),
                          level: T.unsafe(nil), fingerprint: T.unsafe(nil))
  end
...
class Sentry::Span
  ...
  def initialize(transaction:, description: T.unsafe(nil), op: T.unsafe(nil), status: T.unsafe(nil),
                 trace_id: T.unsafe(nil), span_id: T.unsafe(nil), parent_span_id: T.unsafe(nil), sampled: T.unsafe(nil), start_timestamp: T.unsafe(nil), timestamp: T.unsafe(nil))
  end
...
class Sentry::StacktraceBuilder
  ...
  def initialize(project_root:, app_dirs_pattern:, linecache:, context_lines:,
                 backtrace_cleanup_callback: T.unsafe(nil))
  end
...
class Sentry::Transaction < Sentry::Span
  ...
  def initialize(hub:, name: T.unsafe(nil), source: T.unsafe(nil), parent_sampled: T.unsafe(nil),
                 baggage: T.unsafe(nil), **options)
  end
...
class Sentry::Utils::RealIp
  ...
  def initialize(remote_addr: T.unsafe(nil), client_ip: T.unsafe(nil), real_ip: T.unsafe(nil),
                 forwarded_for: T.unsafe(nil), trusted_proxies: T.unsafe(nil))
  end
