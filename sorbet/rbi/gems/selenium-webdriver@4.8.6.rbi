...
class Selenium::WebDriver::ActionBuilder
  ...
  def deprecate_method(device = T.unsafe(nil), duration = T.unsafe(nil), number = T.unsafe(nil), method: T.unsafe(nil))
  end
...
class Selenium::WebDriver::Chrome::Driver < Selenium::WebDriver::Chromium::Driver
  ...
  def initialize(capabilities: T.unsafe(nil), options: T.unsafe(nil), service: T.unsafe(nil), url: T.unsafe(nil),
                 **opts)
  end
...
class Selenium::WebDriver::Chromium::Options < Selenium::WebDriver::Options
  ...
  def enable_android(package: T.unsafe(nil), serial_number: T.unsafe(nil), use_running_app: T.unsafe(nil),
                     activity: T.unsafe(nil))
  end
...
class Selenium::WebDriver::DevTools::NetworkInterceptor
  ...
  def intercept_request(id, params, &); end
...
class Selenium::WebDriver::Firefox::Options < Selenium::WebDriver::Options
  ...
  def enable_android(package: T.unsafe(nil), serial_number: T.unsafe(nil), activity: T.unsafe(nil),
                     intent_arguments: T.unsafe(nil))
  end
...
class Selenium::WebDriver::Logger
  ...
  # source://forwardable/1.3.3/forwardable.rb#231
  def error(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def error?(*args, **_arg1, &); end

  # source://forwardable/1.3.3/forwardable.rb#231
  def fatal(*args, **_arg1, &); end
