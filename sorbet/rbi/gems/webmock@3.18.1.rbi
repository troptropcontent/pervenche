...
module Net::WebMockHTTPResponse
  ...
  def read_body(dest = T.unsafe(nil), &); end
end
...
module WebMock
  ...
  def after_request(*args, &); end
  def allow_net_connect!(*args, &); end
  def disable_net_connect!(*args, &); end
  def net_connect_allowed?(*args, &); end
  def registered_request?(*args, &); end
  def reset_callbacks(*args, &); end
  def reset_webmock(*args, &); end

  class << self
    # source://webmock//lib/webmock/webmock.rb#141
    def after_request(options = T.unsafe(nil), &); end
    ...
    def globally_stub_request(order = T.unsafe(nil), &); end
...
module WebMock::API
  ...
  def assert_not_requested(*args, &); end

  # source://webmock//lib/webmock/api.rb#20
  def assert_requested(*args, &); end
  ...
  def convert_uri_method_and_options_to_request_and_options(method, uri, options, &); end
...
class WebMock::RequestExecutionVerifier
  ...
  def initialize(request_pattern = T.unsafe(nil), expected_times_executed = T.unsafe(nil),
                 at_least_times_executed = T.unsafe(nil), at_most_times_executed = T.unsafe(nil))
  end
...
class WebMock::RequestStub
  ...
  def and_return(*response_hashes, &); end
...
class WebMock::StubRegistry
  ...
  def register_global_stub(order = T.unsafe(nil), &); end
...
class WebMock::VersionChecker
  ...
  def initialize(library_name, library_version, min_patch_level, max_minor_version = T.unsafe(nil),
                 unsupported_versions = T.unsafe(nil))
  end
