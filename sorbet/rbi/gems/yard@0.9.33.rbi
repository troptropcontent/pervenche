...
class IRB::SLex
  ...
  def def_rule(token, preproc = T.unsafe(nil), postproc = T.unsafe(nil), &); end

  # source://yard//lib/yard/parser/ruby/legacy/irb/slex.rb#36
  def def_rules(*tokens, &); end
...
class YARD::CodeObjects::Base
  ...
  class << self
    ...
    def new(namespace, name, *args, &); end
  end
end
...
class YARD::CodeObjects::ClassObject < YARD::CodeObjects::NamespaceObject
  ...
  def initialize(namespace, name, *args, &); end
...
class YARD::CodeObjects::MacroObject < YARD::CodeObjects::Base
  ...
  class << self
    ...
    def apply(docstring, call_params = T.unsafe(nil), full_source = T.unsafe(nil), block_source = T.unsafe(nil),
              _method_object = T.unsafe(nil))
    end
    ...
    def apply_macro(macro, docstring, call_params = T.unsafe(nil), full_source = T.unsafe(nil),
                    block_source = T.unsafe(nil))
    end
...
class YARD::CodeObjects::MethodObject < YARD::CodeObjects::Base
  ...
  def initialize(namespace, name, scope = T.unsafe(nil), &); end
...
module YARD::Handlers::Ruby::DecoratorHandlerMethods
  ...
  def process_decorator(*nodes, &); end
  ...
  def process_decorator_parameter(node, opts = T.unsafe(nil), &); end
end
...
class YARD::I18n::Text
  ...
  def emit_paragraph_event(paragraph, paragraph_start_line, line_no, &); end
...
module YARD::Registry
  ...
  class << self
    ...
    def lock_for_writing(file = T.unsafe(nil), &); end
...
class YARD::Server::Commands::LibraryCommand < YARD::Server::Commands::Base
  ...
  def call_with_fork(request, &); end
...
module YARD::Templates::Template
  ...
  def run(opts = T.unsafe(nil), sects = T.unsafe(nil), start_at = T.unsafe(nil), break_first = T.unsafe(nil), &); end
  ...
  def superb(sect = T.unsafe(nil), &); end
  ...
  def yieldall(opts = T.unsafe(nil), &); end
  ...
  def render_section(section, &); end
