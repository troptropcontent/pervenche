...
module Sidekiq::Job::Options::ClassMethods
  ...
  def sidekiq_retries_exhausted(&); end

  # source://sidekiq//lib/sidekiq/job.rb#76
  def sidekiq_retry_in(&); end
end
...
class Sidekiq::Middleware::Chain
  ...
  def traverse(chain, index, args, &); end
end
