  ...
  class << self
    ...
    def build_subscription_from_hash(subscription_hash)
      new(
        ...
        started_at: Time.at(subscription_hash.dig('subscription', 'started_at')).to_datetime,
        trial_ends_at: Time.at(subscription_hash.dig('subscription', 'trial_end')).to_datetime,
        ...
        next_billing_at: Time.at(subscription_hash.dig('subscription', 'next_billing_at')).to_datetime,
